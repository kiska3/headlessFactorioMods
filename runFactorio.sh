...
/opt/modpackFactorissimo/bin/x64/factorio --config /opt/modpackFactorissimo/config/config.ini --start-server $save \
                 --autosave-interval 10 --afk-autokick-interval 5 --allow-commands restrict \
                 --server-settings /opt/modpackFactorissimo/config/settings.json 